...
##### Wyze-D (Dashboard Top)

ダッシュボードのホーム画面。プランに応じたサマリー情報を表示する。

| 要素ID | 要素名 | 種類 | 説明 |
|---|---|---|---|
| D-01 | 通知アイコン | アイコン | 新着通知がある場合にバッジを表示 |
| D-02 | サマリーカード | カード | 重要な指標（PV、いいね数など）の概略を表示 |
| D-03 | グラフエリア | チャート | (Pro/Basic) 期間別の推移や構成比を表示 |
| D-04 | 最新のアクティビティ | リスト | 直近の投稿や反応のリスト |

##### Wyze-Post (投稿画面)

- テキスト入力、画像アップロード機能を持つ。
- プレビュー機能。

##### Wyze-Report (レポート画面)

- **Pro**: 詳細なグラフ（円グラフ、棒グラフ）でインサイトを提供。
- **Light/Basic**: 基本的な数値のみ、またはアップグレード訴求。
