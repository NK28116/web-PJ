...
> Ready! You are using Stripe API Version [2025-07-30.basil]. Your webhook signing secret is whsec_98f6bd40a1171abbcdca9cbfe70b68f1c344f43fd118d7e2cac0ee59ec1fdaa0 (^C to quit)
```
